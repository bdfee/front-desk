...
import { createTestSpecialist, createTestPatientAndSpecialist, createTestPatient, dropAllTables } from "../helpers";
...
test("complete specialist instance is returned with autogenerated primary key", async () => {
  ...
  expect(specialist).toHaveProperty("specialistId");
  expect(specialist).toHaveProperty("name");
  expect(specialist).toHaveProperty("speciality");
